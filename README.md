...
|13| Practical Neural Networks in PyTorch - Application 2: Handwritten Digits| Create an NN that can classify handwritten digits| ✍️ [W](https://github.com/laikhanhhoang/Deep_Learning_Journey/blob/main/Code/Section13_MNIST.ipynb)|
|14| Convolutional Neural Network| Full theoretical explanation of CNN: Shift variance, Pooling, FC, Dropout, Drop Block, Softmax with Temperature|  💻 [Nb](https://github.com/laikhanhhoang/Deep_Learning_Journey/blob/main/Lecture_Note/Section%2014%20-%20CNN.pdf)|
